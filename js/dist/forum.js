...
/***/ "./src/forum/components/PostImage.js":
/*!*******************************************!*\
  !*** ./src/forum/components/PostImage.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PostImage; });
...
/*#__PURE__*/
function (_Component) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(PostImage, _Component);

  function PostImage() {
    return _Component.apply(this, arguments) || this;
  }

  var _proto = PostImage.prototype;
...
/* harmony import */ var _components_PostImage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/PostImage */ "./src/forum/components/PostImage.js");



app.initializers.add('fof/secure-https', function () {
  var regExp = /<img src="http:\/\/(.+)" title="(.*)" alt="(.*)">/g;
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_CommentPost__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, 'init', function () {
    var content = this.props.post.contentHtml();
    var proxy = app.forum.attribute('fof-secure-https.proxy');
    ...
    if (proxy) {
      ...
      while ((match = regExp.exec(content)) !== null) {
        ...
        newContent = newContent.replace(match[0], "<img src=\"" + app.forum.attribute('apiUrl') + "/fof/secure-https/" + match[1] + "\" title=\"" + match[2] + "\" alt=\"" + match[3] + "\">");
      }
