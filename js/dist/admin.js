...
/***/ "./src/admin/components/SecureHttpsSettingsModal.js":
/*!**********************************************************!*\
  !*** ./src/admin/components/SecureHttpsSettingsModal.js ***!
  \**********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SecureHttpsSettingsModal; });
...
var SecureHttpsSettingsModal =
/*#__PURE__*/
function (_SettingsModal) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(SecureHttpsSettingsModal, _SettingsModal);

  function SecureHttpsSettingsModal() {
    return _SettingsModal.apply(this, arguments) || this;
  }

  var _proto = SecureHttpsSettingsModal.prototype;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_SecureHttpsSettingsModal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/SecureHttpsSettingsModal */ "./src/admin/components/SecureHttpsSettingsModal.js");

app.initializers.add('fof/secure-https', function () {
  app.extensionSettings['fof-secure-https'] = function () {
    return app.modal.show(new _components_SecureHttpsSettingsModal__WEBPACK_IMPORTED_MODULE_0__["default"]());
  };
});
